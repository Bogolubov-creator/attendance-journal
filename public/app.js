...
function adminView() {
  ...
  <div class="admin-columns"><div class="panel"><div class="panel-heading"><div><h2>Список студентов</h2><small>${user.role === "admin" ? "Статистика сверху всегда по факультету, фильтры действуют на таблицу" : "Статистика сверху по вашей зоне ответственности, фильтры действуют на таблицу"}</small></div>${search("admin-search", "Поиск по ФИО", query)}</div>
